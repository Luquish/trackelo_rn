...
// Categorías predefinidas para inversiones
const investmentCategories = [
  { id: 'stocks', name: 'Acciones', icon: 'trending-up', color: '#34C759' },
  { id: 'bonds', name: 'Bonos', icon: 'document-text', color: '#007AFF' },
  { id: 'funds', name: 'Fondos Comunes', icon: 'layers', color: '#a78bfa' },
  { id: 'crypto', name: 'Criptomonedas', icon: 'logo-bitcoin', color: '#f59e0b' },
  { id: 'real-estate', name: 'Inmuebles', icon: 'business', color: '#10b981' },
  { id: 'commodities', name: 'Commodities', icon: 'diamond', color: '#f97316' },
...
export default function AddInvestmentScreen() {
  ...
  const [selectedCategory, setSelectedCategory] = useState('funds');
          ...
          <Animated.View entering={FadeInDown.delay(200)}>
            <YStack space="$2">
              ...
              <Input
                ...
                placeholder="Ej: FCI Money Market"
                borderColor="$borderColor"
                backgroundColor="$background"
                color="$color"
              />
          ...
          <Animated.View entering={FadeInDown.delay(500)}>
            <YStack space="$2">
              ...
              <TextArea
                ...
                placeholder="Agregar detalles sobre la inversión..."
                borderColor="$borderColor"
                backgroundColor="$background"
                color="$color"
                minHeight={80}
