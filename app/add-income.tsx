...
const incomeCategories = [
  { id: 'salary', name: 'Salario', icon: 'briefcase', color: '#4ade80' },
  { id: 'freelance', name: 'Freelance', icon: 'laptop', color: '#60a5fa' },
  { id: 'investment', name: 'Inversión', icon: 'trending-up', color: '#a78bfa' },
  { id: 'business', name: 'Negocio', icon: 'storefront', color: '#f59e0b' },
